        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="product_name" name="name" value="{{ old('name') }}" placeholder="Contoh: Keyboard Mechanical X-Pro" required>
                </div>
                
                <div class="form-group">
                    <label for="sku">SKU (Kode Barang)</label>
                    <input type="text" id="sku" name="sku" value="{{ old('sku') }}" placeholder="Auto-generate saat disimpan" readonly>
                </div>
                
                <div class="form-group">
                    <label for="initial_stock">Stok Awal</label>
                    <input type="number" id="initial_stock" name="current_stock" value="{{ old('current_stock', 0) }}" placeholder="Contoh: 50" min="0">
                </div>
            ...
            <div class="form-footer">
                <a href="{{ route('inventory') }}" class="secondary-button">
                    Batal
                </a>
